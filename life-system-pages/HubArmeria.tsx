...
export function HubArmeria({ defaultSubTab = 'recipes' }: HubArmeriaProps) {
  ...
  return (
    <div className="space-y-6 max-w-7xl mx-auto font-sans">
      ...
      <div className="flex flex-col sm:flex-row items-center justify-between gap-4 bg-white dark:bg-gradient-to-r dark:from-[#0E1424] dark:via-[#0B0F19] dark:to-black text-temple-navy dark:text-temple-navy dark:text-white p-4 md:p-6 rounded-3xl border border-black/10 dark:border-white/10 shadow-2xl">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h2 className="text-xl md:text-2xl font-black text-temple-navy dark:text-temple-navy dark:text-white uppercase tracking-wider">
              Armería & Snack Bar
            </h2>
